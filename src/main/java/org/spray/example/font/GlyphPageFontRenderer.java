...
public class GlyphPageFontRenderer {
    ...
    public static GlyphPageFontRenderer createFromID(String id, int size, boolean bold, boolean italic,
        ...
        try {
            font = Font.createFont(Font.TRUETYPE_FONT, Objects.requireNonNull(CustomTextRenderer.class.getResourceAsStream(id)))
        ...
        try {
            if (bold) {
                boldPage = new GlyphPage(
                        Font.createFont(Font.TRUETYPE_FONT, Objects.requireNonNull(CustomTextRenderer.class.getResourceAsStream(id)))
